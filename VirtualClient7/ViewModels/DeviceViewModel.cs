        ...
        public static Dictionary<string, Uri> Images
        {
            get
            {
                if (_Images == null)
                {
                    ...
                    _Images.Add("fan", new System.Uri(App.FixThemeImage("/Images/dark/fan.png"), UriKind.RelativeOrAbsolute));
                    _Images.Add("kitchen", new System.Uri(App.FixThemeImage("/Images/dark/kitchen.png"), UriKind.RelativeOrAbsolute));
                    _Images.Add("bed,bedroom,sleep", new System.Uri(App.FixThemeImage("/Images/dark/bed.png"), UriKind.RelativeOrAbsolute));

                    _Images.Add("play", new System.Uri(App.FixThemeImage("/Images/dark/play.png"), UriKind.RelativeOrAbsolute));
